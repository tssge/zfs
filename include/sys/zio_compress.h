...
extern int zfs_lz4_decompress(abd_t *src, abd_t *dst, size_t s_len,
    size_t d_len, int level);
extern size_t zfs_deflate_compress(abd_t *src, abd_t *dst, size_t s_len,
    size_t d_len, int level);
extern int zfs_deflate_decompress(abd_t *src, abd_t *dst, size_t s_len,
    size_t d_len, int level);
